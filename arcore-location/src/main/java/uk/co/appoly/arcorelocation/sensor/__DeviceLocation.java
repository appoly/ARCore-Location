...
public class __DeviceLocation implements LocationListener {

    private static final String TAG = __DeviceLocation.class.getSimpleName();
    ...
    public __DeviceLocation(LocationScene locationScene) {
